...
let builtin =
  ...
  ; ("int2char", f Cint2char) (* MCore intrinsics: Arrays**)
  ; ("createMutArray", f (CcreateMutArray None))
  ; ("getMutArray", f (CgetMutArray None))
  ; ("setMutArray", f (CsetMutArray (None, None)))
  ; ("lengthMutArray", f ClengthMutArray) (* MCore intrinsics: Sequences *)
